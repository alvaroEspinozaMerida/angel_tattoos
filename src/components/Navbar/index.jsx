...
const Navbar = () => {
    ...
    return (
        <nav className="bg-dark-primary border-b-2 border-accent">
            <div className="max-w-7xl mx-auto pl-3 pr-12 lg:p-2">
                <div className="flex justify-between h-20">
                    <div className="flex items-center gap-x-5">
                        <div className="flex-shrink-0">
                            <a href="#" className="text-md lg:text-lg text-white py-2 rounded-md font-medium">Martin's Detail (858)-499-9652</a>
                        </div>
            ...
            <div className={isOpen ? "md:hidden" : "hidden"}>
                <div className="w-96 px-3 pt-2 pb-3 space-y-1 sm:px-3">
